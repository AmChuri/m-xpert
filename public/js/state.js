...
var handles = ["Select State","Andaman and Nicobar Islands","Andhra Pradesh","Arunachal Pradesh","Assam","Bihar","Chhattisgarh","Dadra and Nagar Haveli","Daman and Diu","Delhi","Goa","Gujarat","Haryana","Himachal Pradesh","Jammu and Kashmir","Jharkhand","Karnataka",
...
function selct_district($val)
{
 ...
 if($val=='Andaman and Nicobar Islands') {
   var andhra = ["Select City","Bombuflat","Garacharma","Port Blair","Rangat"];
   $(function() {
  var options = '';
